...
def roll_dice(num_rolls, dice=six_sided):
    ...
    for i in range(0,num_rolls):
        ...
        if roll_num == 1:
            ...
            result += roll_num
    return result if not Is1 else 1
    # END PROBLEM 1
...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    my_digits = player_score%10
    opponent_digits = opponent_score//10%10
    score = 3 * abs(my_digits - opponent_digits)
    return max(score,1)
    # END PROBLEM 2
...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    totol = player_score + turn_score
    return sus_points(totol)
    # END PROBLEM 4
...
def always_roll(n):
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"
    def strategy(player_scores,opponent_scores):
        return n
    return strategy
    # END PROBLEM 6
...
def is_always_roll(strategy, goal=GOAL):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    first_strategy = strategy(0,0)
    for player_score in range(goal):
        for opponent_score in range(goal):
             if strategy(player_score,opponent_score) != first_strategy :
                 return False
    return True
...
def make_averaged(original_function, times_called=1000):
    ...
    def averager(*args):
        ...
        for _ in range(times_called):
            totol += original_function(*args)
        return totol/times_called
    return averager
    # END PROBLEM 8
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    max_score = -1
    best_times = 1
    take_averaged = make_averaged(roll_dice,times_called)
    for i in range(1,11):
        current_score = take_averaged(i,dice)
...
def boar_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    item_score = boar_brawl(score,opponent_score)
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    if my score less than opponent_score , will roll 0.
    else will rolls random dice
    """
    # BEGIN PROBLEM 12
    if score < opponent_score :
        return boar_strategy(score,opponent_score)
    else :
